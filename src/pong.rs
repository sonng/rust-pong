...
fn initialise_camera(world: &mut World) {
  ...
  world
    .create_entity()
    .with(
      Camera::from(Projection::orthographic(0.0, ARENA_WIDTH, 0.0, ARENA_HEIGHT))
    )
    .with(transform)
    .build();
}
...
fn initialise_scoreboard(world: &mut World) {
  ...
  let p1_transform = UiTransform::new("P1".to_string(), Anchor::TopMiddle, -50., -50., 1.0, 200., 50., 0);
  let p2_transform = UiTransform::new("P2".to_string(), Anchor::TopMiddle, 50., -50., 1., 200., 50., 0);
